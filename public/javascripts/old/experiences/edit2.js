...
function eventHandlers_for_display_elements(jObj)
{
	...
	jObj.bind("click", function(e){ activate_edit_experience(e);});
}
function activate_edit_experience(e)
{
	activate_edit(e);
}
/*****************************************************/
function eventHandlers_for_addPart_button(jObj)
{
	...
	plusButton.bind("click", function(e){
			activate_addPart_experience(e);
	});
}
function activate_addPart_experience(e)
{
	activate_addPart(e);
}
...
function eventHandlers_for_delete_button(jObj)
{
	jObj.bind("click", function(e){				// jObj is Jquery object for all delte buttons
			delete_the_deleteable_experience(e)
	});
}
function delete_the_deleteable_experience(e)
{
